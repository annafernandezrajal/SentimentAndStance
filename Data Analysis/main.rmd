...
Load data
```{r}
data <- read.csv("Data Analysis/dataset/output_test_classification.csv")
data_reg <- read.csv("Data Analysis/dataset/output_test_regression.csv")
...
plot <- plot.plotWithDiagonalMarked(confusionMatrix1, 'VADER sentiment', 'Actual sentiment')
plot
...
plot <- plot.plotWithDiagonalMarked(confusionMatrix2, 'SVM stance', 'Actual stance')
plot
...
ground_sentiment_stance$Prediction[ground_sentiment_stance$Prediction == 0] <- "Neutral"
ground_sentiment_stance$Reference[ground_sentiment_stance$Reference == 0] <- "Neutral"
ground_sentiment_stance$Prediction[ground_sentiment_stance$Prediction == 1] <- "Positive"
ground_sentiment_stance$Reference[ground_sentiment_stance$Reference == 1] <- "Positive"
ground_sentiment_stance$Prediction[ground_sentiment_stance$Prediction == -1] <- "Negative"
ground_sentiment_stance$Reference[ground_sentiment_stance$Reference == -1] <- "Negative"
...
plot <- plot.plotWithDiagonalMarked(confusionMatrix3, 'Actual sentiment', 'Actual stance')
plot
...
pred_sent_stance$Reference[pred_sent_stance$Reference == 1] <- "FAVOR"
pred_sent_stance$Prediction[pred_sent_stance$Prediction == 1] <- "FAVOR"
pred_sent_stance$Reference[pred_sent_stance$Reference == 0] <- "NONE"
pred_sent_stance$Prediction[pred_sent_stance$Prediction == 0] <- "NONE"
pred_sent_stance$Reference[pred_sent_stance$Reference == -1] <- "AGAINST"
pred_sent_stance$Prediction[pred_sent_stance$Prediction == -1] <- "AGAINST"
...
plot <- plot.plotWithDiagonalMarked(confusionMatrix4, 'VADER sentiment', 'SVM Stance')
plot
ggsave("Data Analysis/images/PredictionSentimentStance.png")
````
