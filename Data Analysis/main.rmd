...
plot.plotWithDiagonalMarked <- function(confusionMatrix) {
  ...
  confusionMatrix_diagonalMarked$ref_freq <- confusionMatrix_diagonalMarked$ref_freq + max(confusionMatrix_diagonalMarked$ref_freq) # This for some reason fixes the colour range not being scaled properly, found by experimentation
