...
plot.plotWithDiagonalMarked <- function(confusionMatrix, xlabel, ylabel, xValueLabels, yValueLabels, valueOrdering) {
  ...
  confusionMatrix_diagonalMarked_plot <- ggplot(
          ...
          geom_text(
             ...
             color = 'black',
             size = 6) +
          scale_x_discrete(labels=xValueLabels, position = "top") +
          scale_y_discrete(labels=yValueLabels) +
          coord_equal() +
          theme_light() +
          theme(
...
plot <- plot.plotWithDiagonalMarked(confusionMatrix2, 'SVM stance', 'Actual stance', stanceValueLabels, stanceValueLabels)
plot
...
plot <- plot.plotWithDiagonalMarked(confusionMatrix3, 'Actual sentiment', 'Actual stance', sentimentValueLabels, stanceValueLabels)
plot
...
plot <- plot.plotWithDiagonalMarked(confusionMatrix4, 'VADER sentiment', 'SVM Stance', sentimentValueLabels, stanceValueLabels)
plot
